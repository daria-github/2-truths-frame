    ...
    <div className="flex min-h-full flex-col justify-center px-6 py-2 lg:px-8 h-screen">
      <main className="flex flex-col items-center justify-center flex-1 px-4 sm:px-20 text-center">
        <img
          ...
          alt="XMTP Logo"
        />
        <h2 className="mt-4 text-center text-3xl font-bold leading-9 text-white">
          2 Truths and a Lie
        </h2>
        <p className="mt-2 text-center text-base font-normal leading-6 text-gray-400">
          Enter your 2 truth and a lie statements and a frame will be created
          for others to guess.
        </p>
