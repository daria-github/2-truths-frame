  ...
  return (
    <div className="flex min-h-full flex-col justify-center h-screen px-6 py-2 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm m-auto">
        ...
        <h1 className="mt-4 mb-6 text-center text-3xl font-bold leading-9 text-white">You've created your 2 Truths and a Lie!</h1>
        <button type="button" class="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-3 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
